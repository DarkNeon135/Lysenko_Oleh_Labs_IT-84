...
public class RoadTest
{
    ...
    {
        fireTruck.addPassenger(policeman);                     //Policeman still seating - Exception
    }
    ...
    public void AddManyTest_Exception()
    {
        ...
        taxi.addPassenger(fireman);                            // no places - Exception
    }
    ...
    {
        taxi.disembarkPassenger(person.getID());              // nobody was here - Exception
    }
}